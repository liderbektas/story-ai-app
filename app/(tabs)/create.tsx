...
import { createStoryAPI } from '../api/story'
  ...
  return (
    <BottomSheetModalProvider>
      ...
      >
        ...
        <View className="flex-1 bg-[rgba(30,41,59,0.6)] px-8 py-10 justify-between">
          <SafeAreaView className="flex-1 justify-center">
            ...
            >
              ...
              <View className="bg-[rgba(30,41,59,0.8)] rounded-3xl p-5">
                ...
                <TextInput
                  ...
                  value={storyState.language}
                  onChangeText={(text) => setStoryState(prev => ({ ...prev, prompt: text }))}
                  style={{
                    height: 160,
                    color: 'white',
            ...
            {['Fantasy', 'Sci-Fi', 'Romance', 'Horror', 'Adventure'].map((style, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && <Ionicons name="checkmark-circle-outline" size={20} color="#84e3f4" />}
                </TouchableOpacity>
              )
            })}
          </BottomSheetView>
